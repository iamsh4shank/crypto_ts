...
def getDataFromCSV(filename):
    ...
    with open(filename, "r", newline="") as file:
        ...
        for row in reader:
            tweetsList.append(row[5])
    return tweetsList

def modifyDate(filename):
    tweetsList = []
    with open(filename, "r", newline="") as file:
        reader = csv.reader(file, delimiter=",")
        for row in reader:
            tweetsList.append(row[6])
    return tweetsList



def get_cumlative_score(filename):
    tweetsList = []
    with open(filename, "r", newline="") as file:
        reader = csv.reader(file, delimiter=",")
        for row in reader:
...
def date_flag(filename):
    date_flag_list = []
    date_list = []
    with open(filename, "r", newline="") as file:
        reader = csv.reader(file, delimiter=",")
        for row in reader:
            date_flag_list.append(row[10])
            date_list.append(row[9])
    return (date_flag_list, date_list)
